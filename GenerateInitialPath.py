...
def initial_zero(a):
    return np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)]), np.array([a for i in range(p.N)])
